...
echo "<table class='table table-hover bg-light ' style='margin-top:50px; '><form method='POST'>";
echo " <thead>
    <tr>
 <th class='alert-success text-center text-uppercase' colspan='7'><b> User Profile for ".$staff_id."</b></th>
    </tr>
    <tr class='alert-light text-dark'><td><b>Sn</b></td><td><b>Surname</b></td><td><b>Name</b></td><td><b>Staff ID</b></td><td><b>Sex</b></td><td><i class='fa fa-trash'></i></td><td><i class='fa fa-refresh'></i></td></b></tr>
  </thead>";{$count=1;
while ($result=mysqli_fetch_array($query)) 
echo"<tbody><tr>"."<td>".$count++."</td>"."<td>" .$result['surname']."</td>"."<td class=''>" .$result['name']."</td>"."<td>" .$result['staff_id']."</td>"."<td class=''>" .$result['sex']."</td>".
