...
<meta charset="utf-8">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item">
        <a class="nav-link" href="vote.php"><i class="fa fa-thumbs-o-up"></i> Vote</a>
      </li>
       </ul>
      <span class="nav-item my-2 my-lg-0">
        <a class="nav-link text-success" href="includes/logout2.php"><i class="fa fa-sign-out"></i>Logout</a>
      </span>
  </div>
</nav>
</div> 
