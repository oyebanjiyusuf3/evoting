...
<meta charset="utf-8">
  ...
  <a class="navbar-brand" href="#"><img src="images/logo.png" alt="yabatech image" height="40" class="logo">&nbsp;<span class="font">Online Staff Voting</span></a>
    ...
    <ul class="navbar-nav mr-auto">
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
          <a class="dropdown-item" href="staffhome.php">Add New Staff</a>
      ...
      <span class="nav-item my-2 my-lg-0">
        <a class="nav-link text-success" href="includes/adminlogout.php"><i class="fa fa-sign-out"></i>Logout</a>
      </span>
  </div>
</nav>
</div> 
